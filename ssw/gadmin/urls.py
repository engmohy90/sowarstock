...
urlpatterns = [
    ...
    url(r'^sample-products/$', views.sample_products_main, name="admin_sample_products_main"),
    url(r'^sample-products/(?P<pk>\d+)/view/$', views.view_sample_product, name="admin_view_sample_product"),
